<%@ Page Title="نظر دهی" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckScript.aspx.cs" Inherits="filmnameh.Script.CheckScript" %>
                            ...
                            <div class="content">
                                ...
                                <section id="loginForm">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <asp:Label runat="server" AssociatedControlID="Score2" CssClass="col-xs-3 control-label">شرح صحنه</asp:Label>
                                            <div class="col-xs-2">
                                        ...
                                        <div class="form-group">
                                            <asp:Label runat="server" AssociatedControlID="Score5" CssClass="col-xs-3 control-label">گفتگو</asp:Label>
                                            <div class="col-xs-2">
