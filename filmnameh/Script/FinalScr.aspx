<%@ Page Title="مشاهده نظر نهایی" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FinalScr.aspx.cs" Inherits="filmnameh.Script.FinalScr" %>
                                    ...
                                    <section id="externalLoginsForm">
                                        ...
                                        <% } else { %>
                                            ...
                                            <dl class="dl-horizontal">
                                                ...
                                                <dt>نویسنده</dt>
                                                <dd><%: GetScript2.First()["Author"]%></dd>
                                                <dt>ارائه دهنده</dt>
                                                <dd><%: GetScript2.First()["Provider"]%></dd>
                                                <dt>زمان ایجاد</dt>
                                                <dd><%: ConvertDate(GetScript2.First()["CreateDate"].ToString()) %></dd>
                                                <dt>گونه</dt>
                                                <dd><%: GetScript2.First()["Genre"]%></dd>
                                                <dt>قالب</dt>
                                                <dd><%: GetScript2.First()["Form"]%></dd>
                                                <dt>موضوع</dt>
                                                <dd><%: GetScript2.First()["Subject"]%> / <%: GetScript2.First()["Side1"]%> / <%: GetScript2.First()["Side2"]%></dd>
                                                <dt>خلاصه</dt>
                                                <dd><%: GetScript2.First()["Summary"]%></dd>
                                                <dt>آخرین طرح</dt>
                                                <dd><%: GetScript2.First()["Text"]%></dd>
                                                <dt>پیوست ها</dt>
                                                <dd><asp:ListView runat="server" id="ListView1" ItemType="System.String">
                                                     <ItemTemplate>
                                                         <li><a href="/upload/<%#Item.Split('_')[0] %>/<%#Item%>"><%#Item%></a></li>
                                                     </ItemTemplate>
                                                </asp:ListView></dd>
                                            ...
                                            <div class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        <asp:Label runat="server" AssociatedControlID="FinalOpinion2" CssClass="col-md-2 control-label">نظر نهایی</asp:Label>
                                                        <div class="col-md-10">
                                                            <asp:TextBox runat="server" ID="FinalOpinion2" CssClass="form-control" TextMode="MultiLine" Rows="4" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <asp:Label runat="server" AssociatedControlID="FinalState2" CssClass="col-md-2 control-label">وضعیت نهایی</asp:Label>
                                                        <div class="col-xs-2">
                                                            <asp:DropDownList runat="server" ID="FinalState2" CssClass="form-control">
                                                                <asp:ListItem Text="--"></asp:ListItem>
                                                                <asp:ListItem Text="بررسی مجدد"></asp:ListItem>
                                                                <asp:ListItem Text="تصویب"></asp:ListItem>
                                                                <asp:ListItem Text="مشروط"></asp:ListItem>
