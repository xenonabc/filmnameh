<%@ Page Title="فیلمنامه‌های من" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FinalScripts.aspx.cs" Inherits="filmnameh.Script.FinalScripts" %>
                                        ...
                                        <asp:ListView runat="server" ID="MyscriptsList" ItemType="System.Collections.Generic.Dictionary`2[System.String,System.Object]">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%#: Item["Title"] %></td>
                                                    <td><%#: Item["State"] %></td>
                                                    <td><a href="<%# "/Script/FinalScript/" + Item["ScriptDetailID"] %>">مشاهده</a></td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:ListView>
                                    </section>
