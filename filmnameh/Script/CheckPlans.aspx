<%@ Page Title="فیلمنامه‌های آماده بررسی" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckPlans.aspx.cs" Inherits="filmnameh.Script.CheckPlans" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:PlaceHolder runat="server" visible='<%# Item["CouncilID"].ToString() == "" %>'>
                                                            <a href="<%# "/Script/CheckPlan/" + Item["ScriptID"] %>">امتیازدهی</a>
                                                        </asp:PlaceHolder>
                                                        <asp:PlaceHolder runat="server" visible='<%# Item["CouncilID"].ToString() != "" %>'>
