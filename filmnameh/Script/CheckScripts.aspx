<%@ Page Title="فیلمنامه‌های آماده بررسی" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckScripts.aspx.cs" Inherits="filmnameh.Script.CheckScripts" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:PlaceHolder runat="server" visible='<%# Item["CouncilID"].ToString() == "" %>'>
                                                            <a href="<%# "/Script/CheckScript/" + Item["ScriptID"] %>">امتیازدهی</a>
                                                        </asp:PlaceHolder>
                                                        <asp:PlaceHolder runat="server" visible='<%# Item["CouncilID"].ToString() != "" %>'>
